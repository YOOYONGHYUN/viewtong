...
import { sourcingControllerCreate } from "@/queries";
...
export type BrandModelType = "modelUse" | "modelNotUse" | "customInput";
...
export interface BrandModelUsage {
  type: BrandModelType;
  customInput?: string;
}
...
export interface PopupStoreUsage {
  type: PopupStoreType[];
  customInput?: string;
}
...
export const reviewProduct = [
  { id: "review", name: "고객 긍정적 후기(리뷰)" },
  { id: "star", name: "높은 별점" },
  { id: "recommend", name: "사용자 추천" },
  { id: "sns", name: "SNS(유튜브, 인스타, 블로그, 틱톡) 추천, 인증" },
];

export const trendProduct = [
  { id: "instagram", name: "인스타그램 화제" },
  { id: "youtube", name: "유튜브 화제" },
  { id: "tiktok", name: "틱톡 화제" },
  { id: "blog", name: "블로그 화제" },
  { id: "community", name: "뷰티 커뮤니티 화제" },
];

export const model = [
  { id: "modelUse", name: "모델 사용" },
  { id: "modelNotUse", name: "모델 미사용" },
  { id: "customInput", name: "기타(직접 입력)" },
];

export const offline = [
  { id: "offlineHb", name: "H&B" },
  { id: "offlineDepartment", name: "백화점" },
  { id: "offlineMart", name: "마트" },
  { id: "offlineHoliday", name: "홀세일" },
  { id: "offlineConvenience", name: "편의점" },
  { id: "customInput", name: "기타(약국, 편집샵 등)" },
];

export const popupStore = [
  { id: "popupStoreDepartment", name: "백화점" },
  { id: "popupStoreRoad", name: "로드(성수, 연남 등)" },
  { id: "customInput", name: "기타" },
  { id: "popupStoreNone", name: "없음" },
];

export const salesChannel = [
  { id: "salesChannelOnline", name: "온라인" },
  { id: "salesChannelOffline", name: "오프라인" },
  { id: "customInput", name: "기타" },
];
...
const MDProductApplyPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (activeStep === 3) {
      ...
      const aplyCn: CreateProductSourcingDtoAplyCn = {
      ...
      try {
        await sourcingControllerCreate({
      ...
      <div className="space-y-6 bg-white rounded-xl shadow-lg p-8">
                ...
                <StepButton
                  ...
                  sx={{
                    "& .MuiStepLabel-root": {
                      ...
                      gap: isMediaMobile ? "4px" : "0px",
                    },
                    "& .MuiStepLabel-iconContainer": {
                      paddingRight: isMediaMobile ? "0px" : "8px",
                    },
                  }}
                >
                  {label}
        ...
        {activeStep === 0 && (
          <div className="space-y-4">
            <div className="w-full text-xl md:text-2xl font-bold flex justify-center my-12">
              어떤 뷰티 상품을 찾는 중이신가요?
            </div>
            {/* 카테고리 */}
            <div>
        ...
        {activeStep === 1 && (
          <div className="space-y-4">
            <div className="w-full text-xl md:text-2xl font-bold flex justify-center my-12">
              <span>채널이 원하는 구체적인 상품 판매 전략을 기입해주세요.</span>
            </div>
            {/* 태그 */}
            <div className="flex flex-row items-center gap-8">
              ...
              >
                찾는 상품의 구체적인 태그 입력 시 조금 더 빠른 발굴이
                가능합니다!
              </Label>
              <Autocomplete
                options={
        ...
        {/* 등록 버튼 */}
        <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4 pt-4">
          <Button
            disabled={activeStep === 0}
            className="flex-1 h-12 text-base md:text-lg font-bold bg-[#4a81d4] hover:bg-[#3561a7] text-white rounded-lg"
            onClick={handleBack}
          >
            이전
          </Button>
          <Button
            className="flex-1 md:w-[49%] h-12 text-base md:text-lg font-bold bg-[#4a81d4] hover:bg-[#3561a7] text-white rounded-lg"
            onClick={handleSubmit}
          >
            {activeStep === 3 ? "의뢰하기" : "다음"}
          </Button>
        </div>
      </div>
      <Dialog
...
export default MDProductApplyPage;
