...
const SelectUserType = ({ onUserTypeChange }: SelectUserTypeProps) => {
  ...
  const handleNext = () => {
    if (selectedType) {
      onUserTypeChange?.(selectedType as UserType);
    } else {
      alert("유형을 선택해주세요.");
    }
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div
            className={`bg-white shadow-md rounded-lg overflow-hidden border-2 ${
              selectedType === "02" ? "border-blue-500" : "border-transparent"
